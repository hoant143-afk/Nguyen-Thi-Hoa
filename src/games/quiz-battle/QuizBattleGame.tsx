        ...
        {gameState === 'SETUP' && (
          <div className="max-w-2xl mx-auto w-full bg-slate-900/90 border border-slate-800 rounded-3xl p-5 sm:p-7 shadow-2xl space-y-6">
            ...
            <div className="p-3 bg-slate-950/60 rounded-2xl border border-slate-800 flex items-center justify-between text-xs text-slate-300">
              <span>Số câu hỏi: <strong className="text-amber-400 font-bold">{questions.length} câu</strong></span>
              <span>Thời gian/câu: <strong className="text-cyan-400 font-bold">20 giây</strong></span>
            </div>
